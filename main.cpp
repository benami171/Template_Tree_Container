...
//         // Example tree
//         Node<double> _root_node = Node(1.1);
//         Tree<double> _tree;
//         _tree.add_root(_root_node);
//         Node<double> _n1 = Node(1.2);
//         Node<double> _n2 = Node(1.3);
//         Node<double> _n3 = Node(1.4);
//         Node<double> _n4 = Node(1.5);
//         Node<double> _n5 = Node(1.6);
//         _tree.add_sub_node(_root_node, _n1);
//         _tree.add_sub_node(_root_node, _n2);
//         _tree.add_sub_node(_n1, _n3);
//         _tree.add_sub_node(_n1, _n4);
//         _tree.add_sub_node(_n2, _n5);

//         drawTree(scene, _tree.get_root(), 400, 30, 200);
//     }
