...
# Project:  myProg.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile myProg.pro -config Test
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = Test1.0.0
DISTDIR = /home/benami/ss2course/System_Programming2_Exe4/.tmp/Test1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: myProg.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		myProg.pro
	$(QMAKE) -o Makefile myProg.pro -config Test
...
distdir: FORCE
	...
	$(COPY_FILE) --parents node.hpp tree.hpp iterators.hpp complex.hpp doctest.h $(DISTDIR)/
	$(COPY_FILE) --parents test.cpp $(DISTDIR)/


clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) Test Prog .qmake.stash *.o
	-$(DEL_FILE) *~ core *.core
