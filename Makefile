...
# Project:  myProg.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile myProg.pro -config Prog
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = Prog1.0.0
DISTDIR = /home/benami/ss2course/System_Programming2_Exe4/.tmp/Prog1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: myProg.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		myProg.pro
	$(QMAKE) -o Makefile myProg.pro -config Prog
